 ...
 * @author Admin
 */
public class MainLoginJdialog extends javax.swing.JDialog {

    private NhanVien_Service service = new NhanVien_Service();
    private Auth auth = new Auth();

    public MainLoginJdialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainLoginJdialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MainLoginJdialog dialog = new MainLoginJdialog(new javax.swing.JFrame(), true);
